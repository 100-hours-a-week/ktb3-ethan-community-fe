...
- 게시글 피드: Masonry 레이아웃 + IntersectionObserver 기반 무한 스크롤 + 최근 본 게시글 저장/삭제
...
### 게시글 피드(Masonry 레이아웃, 무한 스크롤, 최근 본 게시글 저장/삭제)

|Masonry 레이아웃(사이드바 표시)|사이드바 숨기기|
|--|--|
| ![](/sample/home/무한스크롤%20+%20최근%20본%20게시글.png)|![](/sample/home/무한%20스크롤%20+%20화면%20숨김%20+%20게시글%20정보%20미리보기.png)|

### 게시글 CRUD
|게시글 상세보기|
|--|
|![](/sample/post/게시글%20상세보기%20+%20최근%20본%20게시글%20추가.png)|
### 댓글 CRUD
|댓글 CRUD|
|--|
|![](/sample/comment/댓글%20작성.png)|
